...
public class PlayerCode : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        HandleShooting();
        if (GlobalVariables.waveCounter % 7 == 0 && isHealable && life < 3 && GlobalVariables.waveCounter > 1)
        {
            isHealable = false;
            HandleHeal();
        }
    ...
    void HandleHeal()
    {
        Vector3 spawnPosition = new Vector3(Random.Range(-7f, 5f), 5f, Random.Range(-7f, 10f));
