...
public class UmmovableEnemy : MonoBehaviour
{
    Rigidbody rb;
    ...
    [HideInInspector] public Vector3 shootDirection = new Vector3(0f, 0f, -1f);
    ...
    Vector3 direction = new Vector3(0, 0, -100);
...
void Update()
{
    ...
    void FixedUpdate()
    {
        ...
        if (GlobalVariables.waveCounter >= 4 && GlobalVariables.waveCounter <= 7)
        {
