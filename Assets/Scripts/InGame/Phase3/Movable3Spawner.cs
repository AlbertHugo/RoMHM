...
public class Movable3Spawner : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (GlobalVariables.waveCounter == 9 && isSpawning == 0)
        {
            isLateWave = 0;
            numberOfEnemies = 1;
            startSpawnPosition = new Vector3(-7f, 5f, 7f);
    ...
    IEnumerator SpawnEnemies()
    {
        ...
        for (int i = 0; i < numberOfEnemies; i++)
        {
            ...
            Movable3Enemy movableEnemy = enemy.GetComponent<Movable3Enemy>();
