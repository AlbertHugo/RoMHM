...
public class MegaTrap : MonoBehaviour
{
    Rigidbody rb;
    ...
    void Update()
    {
        ...
        {
        bossAttacks.ShootCharged(bullet, enemy, 10, 0.1f, 4f);
        nextFireTime = Time.time + fireRate;
        }
        enemy.LookAt(enemy.position + shootDirection);
}
